...
export default function ErrorPage({
  ...
  return (
    <main className="flex min-h-svh flex-col items-center justify-center px-5 text-center bg-void">
      ...
      <h1 className="font-display font-[300] text-7xl md:text-8xl lg:text-9xl tracking-[0.12em] leading-none my-6 bg-gradient-to-b from-[#ffd9c2] to-[#ff6b3d] bg-clip-text text-transparent select-none">
        500
      </h1>
